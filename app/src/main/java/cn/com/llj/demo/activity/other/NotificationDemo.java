...
import cn.com.llj.demo.activity.timeView.DatepickerdialogDemo;

/**
 * 三星中setSmallIcon是显示在状态栏上面的图片，setLargeIcon是显示在通知栏里面item左边的图片，右下角没有图片实现，显示的是number字段
 * 小米中setSmallIcon和setLargeIcon同时设置才显示在通知栏里面item右下角的图片(且显示的是setSmallIcon设置的图片)，并且显示number字段，左边的图标是应用的icon
 * <p/>
 * Created by liulj on 15/11/18.
 */
public class NotificationDemo extends DemoActivity {
    private static int NOTIFICATION_FLAG = 1;

    @Override
    public int getLayoutId() {
        return R.layout.notification_demo;
    }
    ...
    public void notificationMethod(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn1:
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, DatepickerdialogDemo.class), 0);
                ...
                notify1.tickerText = "TickerText:您有新短消息，请注意查收！";// 设置在status
            ...
            case R.id.btn2:
                PendingIntent pendingIntent2 = PendingIntent.getActivity(this, 0,
                        new Intent(this, DatepickerdialogDemo.class), 0);
                // 通过Notification.Builder来创建通知，注意API Level
                // API11之后才支持
                Notification notify2 = new Notification.Builder(this)
                        .setSmallIcon(R.drawable.ic_discuss) // 设置状态栏中的小图片，尺寸一般建议在24×24，这个图片同样也是在下拉状态栏中所显示，如果在那里需要更换更大的图片，可以使用setLargeIcon(Bitmap// icon)
            ...
            case R.id.btn3:
                PendingIntent pendingIntent3 = PendingIntent.getActivity(this, 0,
                        new Intent(this, DatepickerdialogDemo.class), PendingIntent.FLAG_ONE_SHOT);
                // 通过Notification.Builder来创建通知，注意API Level
                // API16之后才支持
                ...
                manager.notify(2, notify3);// 步骤4：通过通知管理器来发起通知。如果id不同，则每click，在status哪里增加一个提示
                break;
            // 自定义通知
            case R.id.btn4:
