 ...
 */
public class RenderScriptDemo extends DemoActivity {
    ...
    public int getLayoutId() {
        return R.layout.render_script_demo;
    }
    ...
    private void createScript() {
        ...
        mScriptMatrix = ScriptIntrinsicColorMatrix.create(mRS, Element.U8_4(mRS));
    }
