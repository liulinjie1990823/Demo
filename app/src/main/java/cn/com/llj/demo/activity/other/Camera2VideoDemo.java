...
public class Camera2VideoDemo extends DemoActivity {
    /**
    ...
    /**
     * Opens the camera specified by {@link Camera2VideoDemo#mCameraId}.
     */
    ...
    @OnClick(R.id.info)
    public void info() {
        new AlertDialog.Builder(this).setMessage(R.string.intro_message).setPositiveButton(android.R.string.ok, null).show();
    }
