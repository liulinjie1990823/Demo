...
/**
 * Created by liulj on 15/11/27.
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP)
public class Camera2VideoDemo extends DemoActivity implements View.OnClickListener {
    ...
    public int getLayoutId() {
        return R.layout.camera2_video_demo;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.info: {
                new AlertDialog.Builder(mBaseFragmentActivity)
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                    Toast.makeText(mBaseFragmentActivity, "Failed", Toast.LENGTH_SHORT).show();
                }
            }, mBackgroundHandler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(this, "Video saved: " + getVideoFile(this), Toast.LENGTH_SHORT).show();
        startPreview();
    }
