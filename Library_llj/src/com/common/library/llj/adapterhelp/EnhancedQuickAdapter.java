...
/**
 * Same as QuickAdapter, but adds an "itemChanged" boolean in the convert() method params, which allows you to know if you are adapting the new view to the same item or not, and therefore make a
 * difference between dataset changed / dataset invalidated.
 * <p/>
...
public abstract class EnhancedQuickAdapter<T> extends QuickAdapter<T> {
	...
	@Override
	protected final void convert(BaseAdapterHelper helper, View convertView, T item, int position) {
