package com.common.library.llj.typefacehelper;
...
public class TypefaceCollection {
	...
	public static class Builder {
		...
		/**
		 * This typeface is set in fist {@link #set(int, android.graphics.Typeface)} call and is used for all unset styles in {@link #create()} call
		 */
		...
		/**
		 * Creates typeface collection. If not all styles are set, uses fist typeface that has been set for all unset styles.
		 * 
		 * @throws IllegalStateException
		 *             when no {@link android.graphics.Typeface} has been set via {@link #set(int, android.graphics.Typeface)}
	...
	public static TypefaceCollection createSystemDefault() {
		return new Builder().set(Typeface.NORMAL, Typeface.DEFAULT).set(Typeface.BOLD, Typeface.DEFAULT_BOLD).set(Typeface.ITALIC, Typeface.DEFAULT).set(Typeface.BOLD_ITALIC, Typeface.DEFAULT_BOLD)
				.create();
	}
