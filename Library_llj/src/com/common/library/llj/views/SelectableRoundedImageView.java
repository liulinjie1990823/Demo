...
public class SelectableRoundedImageView extends ImageView {
	...
	// 更新SelectableRoundedCornerDrawable的属性
	...
	static class SelectableRoundedCornerDrawable extends Drawable {
		...
		// 传入bitmap生成SelectableRoundedCornerDrawable
		...
		// 传入drawable生成SelectableRoundedCornerDrawable
		...
		public void draw(Canvas canvas) {
			canvas.save();
			// 如果没有设置边界参数，这里的边界包括图片边界，如果有边框那还有带边框的边界
