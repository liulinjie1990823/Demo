...
public class WhorlView extends View {
    ...
    private static final int PARALLAX_SLOW = 1;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLayerColors.length; i++) {
            float angle = 0;
            if (i == 0) {
                angle = (mCircleSpeed + mParallaxSpeed * i) * mCircleTime * 0.001f + 90;
            } else if (i == 1) {
                angle = ((mCircleSpeed + mParallaxSpeed * i) * mCircleTime * 0.001f + 90);
            } else if (i == 2) {
                angle = -((mCircleSpeed + mParallaxSpeed * i) * mCircleTime * 0.001f + 180);
            } else if (i == 3) {
                angle = ((mCircleSpeed + mParallaxSpeed * i) * mCircleTime * 0.001f + 180);
            }
